    ...
    return (
        ...
        <div style={{overflowX:"hidden"}}>
            ...
            <div style={{height:"603px", paddingLeft:"600px", paddingTop:"150px", paddingRight:"150px"}} className="bg-light">
                ...
                <div class="row">
                    <p class="col-6 text-secondary">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
            ...
            <div class="px-5 py-5 bg-light" >
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-3">
                        ...
                        <Card.Body>
                            <Card.Title>The Strength of a People.
                            Power of Community</Card.Title>
                            <Card.Text>
                        ...
                        <Card.Body>
                            ...
                            <Card.Link className="btn btn-danger" href="#">Donate</Card.Link>
                        </Card.Body>
                        </Card>
                    </div>
                    {/* card */}
                    <div class="offset-1 col-3">
                        ...
                        <Card.Body>
                            <Card.Title>Empowering Communities
                            Ending Poverty</Card.Title>
                            <Card.Text>
                            Some quick example text to build on the card title and make up the bulk of
                            the card's content.
                            </Card.Text>
